    ...
    <>
      ...
      <Formik
        ...
        validationSchema={yup.object().shape({
          ...
          instructions: yup
            .string()
            .min(10, "Instructions can not be less than 4 characters")
            .max(500)
            ...
            <Form className="login-form">
              ...
              >
                <Input
                  ...
                  prefix={
                    <Icon type="fire" style={{ color: "rgba(0,0,0,.25)" }} />
                  }
                />
              </Form.Item>
              <Form.Item>
                <Radio.Group
                  defaultValue={values["vegeterian"]}
                  buttonStyle="solid"
                >
              ...
              >
                ...
                <InputNumber
                  ...
                  max={15}
                  defaultValue={3}
                  onChange={e => setFieldValue("people", e)}
                />
              </Form.Item>
              ...
              >
                  ...
                  {values["ingredients"].map((item, index) => (
                    <li key={index}>
                      ...
                      <Icon
                        type="delete"
                        onClick={() => {
                          let items = values["ingredients"].filter(
                            x => x !== item
                          );
                          setFieldValue("ingredients", items);
                        }}
                        style={{ marginLeft: "7px", color: "rgba(255,0,0)" }}
                      />{" "}
                    </li>
                  ))}
                </ul>
                <Input
                  ...
                  onChange={e => setFieldValue("tmp", e.target.value)}
                  onKeyDown={e => {
                    if (e.keyCode === 13) {
              ...
              <Form.Item>
                {values["image"] && values["image"].length !== 0 ? (
                  <img
                    ...
                    src={`http://localhost:3001/photos/${values["image"]}`}
                    alt="Food"
                  />
                ) : null}
                <FilePond
